        ...
        <div class="col-lg-8">
          <div class="ul-event-details ul-donation-details">
            <div class="ul-event-details-img">
              <img src="{{ asset('front') }}/assets/img/asaha.webp" alt="Image">
            </div>
            ...
            <h2 class="ul-event-details-title">Aasha 2023 – Healing Minds Together
            </h2>
            <p class="ul-event-details-descr">On May 20, 2023, Gyandeep Welfare and Rehabilitation Society organized
              Aasha 2023 at Gyandeep School, Dasuya, Punjab—a compassionate support camp dedicated to the mental and
              emotional well-being of parents raising children with special needs. The word Aasha, meaning “hope,”
              perfectly captured the spirit of the day as families came together to heal, share, and grow.
            </p>
            <p>The event created a safe space for parents to relax, reconnect, and receive guidance from professionals.
              Through a blend of therapy sessions, yoga workshops, and one-on-one counseling, Aasha 2023 provided tools
              to manage stress, strengthen emotional resilience, and build a stronger support system within families
              navigating disability care.
            </p>
            <h3 class="ul-event-details-inner-title">Highlights of the Event
            </h3>
            <p class="ul-event-details-descr">Designed with empathy and empowerment at its core, Aasha 2023 supported
              caregivers who are often the unsung heroes in the journey of special education and rehabilitation.
            </p>
            <ul class="ul-event-details-list">
              <li>Group therapy sessions led by licensed psychologists
              </li>
              <li>Yoga and mindfulness workshops to manage stress and anxiety
              </li>
              <li>Parent counseling booths for personalized guidance
              </li>
              <li>Interactive Q&A on child behavior and care strategies
              </li>
              <li>Resource support on disability rights and services</li>
            </ul>

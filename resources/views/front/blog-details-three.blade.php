            ...
            <div class="ul-blog-details ul-blog-inner mb-0">
              <div class="ul-blog-2 ul-blog-inner">
                ...
                <div class="ul-blog-txt">
                  ...
                  <h2 class="ul-blog-title">Skill Training for a Dignified Tomorrow.</h2>
                  <div class="ul-donation-details-summary-txt ul-blog-details-txt">
                    <p>When opportunity meets preparation, dignity follows. At Gyandeep Welfare & Rehabilitation
                      Society, our vision goes beyond care—it’s about equipping individuals with the tools to thrive
                      independently, to earn with dignity, and to dream with purpose.</p>
                    <p>Children, youth, and adults with disabilities often face harsh societal barriers: from
                      inaccessible education and lack of inclusive training spaces to biased hiring practices. Gyandeep
                      counters this by creating barrier-free skill development environments where potential—not
                      disability—is the focus.</p>
                    <blockquote>“I never thought I’d get a job. But Gyandeep helped me with resume building and
                      placement support. I now work as a shop assistant and feel independent for the first time.”
                      — Harjit Singh, 24, Retail Assistant Trainee</blockquote>
                    <p>Our flagship skill-building initiative, "Udaan", celebrates this very journey. Over six months,
                      trainees learn practical skills aligned with market needs, supported by compassionate trainers and
                      inclusive learning modules. The course culminates in an exhibition and certification ceremony
                      where learners showcase their talents—handmade jewelry, digital art, customized fabric crafts, and
                      more.</p>
                    ...
                    <p>What makes this program stand out is that it doesn't end at training. Each graduate receives a
                      toolkit and ongoing mentorship to either launch their own small business or integrate into

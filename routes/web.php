...
use App\Http\Controllers\front\ProjectFc;
...
Route::get('/projects', [ProjectFc::class, 'index'])->name('projects');
Route::get('/projects/{project_slug}', [ProjectFc::class, 'detail'])->name('project.detail');
...
Route::get('test/print', [TestController::class, 'index']);
